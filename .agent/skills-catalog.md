...
The global library is a **reference/inspiration source** — not the primary skill store. Use it to see how others have solved similar problems, then write a local skill tailored to this project.
